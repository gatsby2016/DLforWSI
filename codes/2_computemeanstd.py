...
def GetArgs():
    ...
    parser.add_argument('-P', '--path', type=str,
                        default=['/home/cyyan/projects/ccRCC/data/train/tumor/',
                                 '/home/cyyan/projects/ccRCC/data/train/non/'
                                 ], help='Img path1')
    parser.add_argument('-S', '--savepath', type=str, default='../results/MeanStd.npz',
